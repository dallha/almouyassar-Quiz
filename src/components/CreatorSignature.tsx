/**
 * CreatorSignature — Section signature premium du créateur
 *
 * Section émotionnelle qui conclut l'expérience avec élégance.
 * Design inspiré par la tradition, pensé pour les nouvelles générations.
 */
...
export default function CreatorSignature() {
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[var(--color-deep-green)]/[0.02] to-[var(--color-deep-green)]/[0.06]" />
            ...
            <div className="relative max-w-xs mx-auto mb-12">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <Sparkles size={12} className="text-[var(--color-gold)]/30" />
                </div>
            </div>

            {/* Contenu */}
            <div className="relative z-10 max-w-lg mx-auto px-4 text-center space-y-6">
                {/* Avatar stylisé */}
                <motion.div
                ...
                >
                    ...
                    >
                        <span className="text-white text-lg font-bold font-display tracking-wide">MN</span>
                    </div>
                ...
                <motion.div
                    ...
                    className="space-y-2"
                >
                    <h3 className="text-sm font-bold text-[var(--color-deep-green)] font-display tracking-wide">
                ...
                >
                    {socialLinks.map((link) => (
                        <a
                            ...
                            className="w-9 h-9 rounded-full bg-[var(--color-deep-green)]/[0.04]
